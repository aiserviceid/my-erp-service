    ...
    <main className="unitpro-page">
      ...
      <section id="harga" className="unitpro-section unitpro-pricing-section">
        ...
        <div className="unitpro-pricing-grid">
          <article className="unitpro-price-card"><p className="unitpro-price-label">Gratis</p><h3>Fondasi rapi untuk satu toko</h3><div className="unitpro-price"><strong>Rp0</strong><span>/ selamanya</span></div><ul><li><Check size={16} /> Terima servis dengan resi digital yang rapi</li><li><Check size={16} /> Catat penjualan kasir tanpa buku tulis</li><li><Check size={16} /> Pantau stok sparepart yang paling dibutuhkan</li><li><Check size={16} /> Beri pelanggan akses tracking mandiri</li></ul><button className="unitpro-button outlined" onClick={() => navigate('/login', { state: { tab: 'register', tier: 'free' } })}>Mulai gratis</button></article>
          <article className="unitpro-price-card featured"><div className="unitpro-price-badge">Pilihan utama</div><p className="unitpro-price-label">UnitPro Pro</p><h3>Operasional profesional, setiap hari</h3><div className="unitpro-price"><strong>{proPrice}</strong><span>{proTerm}</span></div><ul><li><Check size={16} /> Kelola servis, kasir, dan stok dalam satu alur</li><li><Check size={16} /> Kirim nota profesional dengan QRIS dan identitas toko</li><li><Check size={16} /> Hubungi pelanggan lebih cepat lewat WhatsApp</li><li><Check size={16} /> Lihat laporan penjualan dan arus kas toko</li><li><Check size={16} /> Libatkan hingga 10 akun karyawan dalam operasional</li></ul><button className="unitpro-button primary" onClick={() => navigate('/login', { state: { tab: 'register', tier: 'pro', billing: billingCycle } })}>Pilih UnitPro Pro <ArrowRight size={18} /></button></article>
          <article className="unitpro-price-card coming-soon"><div className="unitpro-price-badge neutral">Segera hadir</div><p className="unitpro-price-label">Enterprise</p><h3>Standar baru untuk jaringan servis</h3><div className="unitpro-price"><strong>Disiapkan khusus</strong></div><p className="unitpro-price-promo">Untuk pemilik yang ingin mengendalikan beberapa outlet dan tim dari satu pusat keputusan.</p><ul><li><Building2 size={16} /> Pantau kinerja seluruh cabang dari satu dashboard</li><li><Check size={16} /> Bandingkan penjualan dan operasional setiap outlet</li><li><ShieldCheck size={16} /> Atur akses pemilik, admin, kasir, dan teknisi</li><li><Check size={16} /> Kelola distribusi stok antar outlet dengan lebih terukur</li></ul><button className="unitpro-button outlined" type="button" disabled>Segera hadir</button></article>
        </div>
      </section>
